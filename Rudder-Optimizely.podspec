Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/rudderlabs/rudder-integration-optimizely-ios.git' , :commit => 'db5155f9a4d43464039acf4d9bca0e0e05b33e34'}
  s.platform         = :ios, "9.0"
  s.requires_arc = true
  ...
  s.dependency 'Rudder', '~> 1.0.3'
  s.dependency 'OptimizelySDKiOS', '~> 3.0.0'
end
